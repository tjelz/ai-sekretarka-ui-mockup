    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50/30 to-white">
      ...
      <section className="py-8 sm:py-10 px-4">
        <div className="container mx-auto max-w-4xl text-center">
          <div className="inline-flex items-center gap-2 bg-blue-50 text-[#007BFF] px-4 sm:px-5 py-2 sm:py-2.5 rounded-full text-xs sm:text-sm font-medium mb-3 sm:mb-4">
            ...
            <div className="space-y-5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 sm:gap-3">
                <div className="text-center p-3 rounded-xl bg-gray-50 border border-gray-200">
                  <div className="text-2xl sm:text-3xl font-black text-[#007BFF] mb-1">
