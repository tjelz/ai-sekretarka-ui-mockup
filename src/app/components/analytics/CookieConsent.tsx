          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
              <button
                ...
                className="min-w-[100px] bg-gray-200 hover:bg-gray-300 text-gray-800 px-4 py-2 rounded-md"
              >
                Odrzuć
              </button>
              <button
                onClick={handleAccept}
                className="min-w-[100px] bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md"
              >
                Akceptuj
              </button>
            </div>
